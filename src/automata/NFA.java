...
class NFA extends Automaton {
   ...
   static enum State {a, b, c, d} //enumerated class
   ...
   public Set<State> delta(State q, char c) {
     ...
     if (q==State.b && c=='1') return EnumSet.of(State.c); 
     if (q==State.c && c=='1') return EnumSet.of(State.d); 
   ...
   public boolean accept(String w) {
      ...
      return (S.contains(State.d));  //acceptable?
   } 
